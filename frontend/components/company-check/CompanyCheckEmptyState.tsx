...
export function CompanyCheckEmptyState() {
  return (
    <div className="py-16 flex flex-col items-center justify-center text-center opacity-70 hover:opacity-100 transition-opacity duration-500 animate-in fade-in zoom-in-95 duration-700">
      <div className="h-20 w-20 rounded-full border border-dashed border-slate-700 bg-black/40 flex items-center justify-center mb-6 shadow-inner">
        <Building2 className="h-8 w-8 text-slate-600" />
      </div>
      <h3 className="text-xl font-bold text-slate-100 tracking-tight">Ready to Scan</h3>
